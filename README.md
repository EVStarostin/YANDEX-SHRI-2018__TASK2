...
3-е устройство отличается от того, чтобы было в макете. В макете нет *Xiaomi Warm Floor*, пришлось добавить его вместо *Elgato Eve Degree Connected*, чтобы была возможность посмотреть работу регулятора **температуры теплого пола**.  
